...
**Legacy schema-3 delivery evidence remains readable.** A retained `NOT-MEASURED` verdict still blocks SHIP exactly as recorded. New runs no longer produce delivery observations or `NOT-MEASURED`; they use schema 2.

...
export interface ReviewedExportPolicy {archiveRoot:string;access?:GovernedArchiveRoute;manifestIds:string[];destination:string;expiresAt:number;redact:string[];maxBytes:number}

 ...
 * two directories below the package root (`packages/pi-extension/{src,dist}/`),
 * which itself lives two below the repo root (`packages/pi-extension/`), so
 * `../../../assets` from either location lands on the repo-root `assets/`.
 */

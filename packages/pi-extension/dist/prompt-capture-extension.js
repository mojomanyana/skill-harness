...
import { appendFileSync as appendFileSync4, readFileSync as readFileSync23, rmSync as rmSync6 } from "node:fs";
...
// packages/adapters/src/prompt-provenance.ts
function sha(bytes) {
  return createHash10("sha256").update(bytes, "utf8").digest("hex");
}

...
writeFileSync(out+'/receipt.json',JSON.stringify({checks:10,liveCalls:0,realCredentialReads:0,readiness,sourcePins:pins,actualResult:result.result,process:processEvidence,scope:'selected executable -> supervised original producer five-role worker; fixture only'},null,2)+'\n');
console.log(JSON.stringify({passed:10,evidence:out,liveCalls:0,realCredentialReads:0}));

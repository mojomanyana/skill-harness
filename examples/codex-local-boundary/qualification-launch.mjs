...
export function loadLaunch(path,mode,approvalPath){
 ...
 const product=config.version==='supervised-producer-product-launch-v1';
 closed(config,['version','profile','manifest','pins','limits',...(product?['product']:[])]);if(!['supervised-producer-launch-v1','supervised-producer-product-launch-v1'].includes(config.version)||!['fixture','subscription-live'].includes(config.profile))throw Error('launch profile');
